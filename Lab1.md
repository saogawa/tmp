...
```jsx
configure system name lab1-sr1
```
...
configure router "Base" interface "To-Peering-LAN" ipv4 primary address 192.168.1.1 prefix-length 24
configure router "Base" interface "To-Peering-LAN" ipv6 address 2000:1:1::1 prefix-length 64

configure router "Base" interface "To-LAN" port 1/1/c2/1
configure router "Base" interface "To-LAN" ipv4 primary address 192.168.10.1 prefix-length 30
...
```jsx
    ...
    /configure router "Base" bgp neighbor "192.168.1.3" admin-state enable
    /configure router "Base" bgp neighbor "192.168.1.3" group "eBGP-Peering"
    /configure router "Base" bgp neighbor "2000:1:1::3" group "eBGP-Peering"
    /configure router "Base" bgp neighbor "2000:1:1::3" local-address 2000:1:1::1
